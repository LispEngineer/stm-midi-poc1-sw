...
static void MX_UART5_Init(void)
{
  ...
  */
  ...
  NVIC_SetPriority(UART5_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),2, 1));
...
static void MX_USART3_UART_Init(void)
{
  ...
  */
  ...
  NVIC_SetPriority(USART3_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),2, 1));
...
static void MX_USART6_UART_Init(void)
{
  ...
  */
  ...
  NVIC_SetPriority(USART6_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),2, 0));
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : GPIO_PA6_Pin */
  GPIO_InitStruct.Pin = GPIO_PA6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
